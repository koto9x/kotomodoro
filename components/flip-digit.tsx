 ...
 * Uses a full-height container with the digit centered, then clips
 * via overflow:hidden on a half-height wrapper.
 */
function HalfDigit({ char, half }: { char: string; half: 'top' | 'bottom' }) {
  return (
    <div
      ...
      style={{
        // Shift the full digit up or down so the correct half is visible
        // in the clipped container
        top: half === 'top' ? 0 : '-100%',
      }}
    >
